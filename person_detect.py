...
Purpose : Written for Smart Queuing System Project which is a part of Intel Edge AI for IOT Udacity Nanodegree 
...
#Class for Person Detection Model
class PersonDetect:
    def __init__(self, model_name, device, threshold=0.60):
        ...
        print("Loading Model and Network........")
    def load_model(self):
        self.core = IECore()
    ...
    def predict(self, image):      
        ...
        ''' Starting a asynchronous inference for request '''
        print("Starting a asynchronous inference for request")
...
def main(args):
    ...
    try:
        ...
        print("Cannot locate video file which was provided for input: "+ video_file)
    except Exception as e:
